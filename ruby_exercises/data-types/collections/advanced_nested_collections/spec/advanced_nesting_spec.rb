...
RSpec.describe 'Advanced Nested Collections' do
  ...
  it 'test 7' do
    ...
    # all restaurants
    employee_names = []
    #? ==== better using a loop or flatten? 
    # stores.keys.each do |store|
    #   stores[store][:employees].each do |employee|
    #     employee_names << employee
    #   end
    stores.keys.each do |store|
      employee_names << stores[store][:employees]
    end
  ...
  it 'test 8' do
    ...
    ingredients = []
    # stores.keys.each do |store|
    #   stores[store][:dishes].each do |dish|
    #     dish[:ingredients].each {|ingredient| ingredients << ingredient}
    #   end
    # end
    stores.keys.each do |store|
      stores[store][:dishes].each do |dish|
